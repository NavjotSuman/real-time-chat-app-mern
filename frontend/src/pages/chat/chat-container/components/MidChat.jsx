...
const MidChat = () => {
  ...
  const downloadFile = async (fileUrl) => {
    ...
    // a.href = fileUrl;
    // a.className = "hidden"
    // a.download = fileUrl.fileName; // Replace with your desired filename
    ...
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w[70vw] xl:w-[80vw] w-full">
      ...
      <div ref={scrollRef} />
      {
        showImage && <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
          <div>
            <img src={imageUrl} className="h-[80vh] w-full bg-cover" alt="" srcset="" />
          </div>
      ...
      {
        showVideo && <div className="fixed z-[1000] top-0 left-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
          <div>
            <video src={videoUrl} className="h-[85vh] w-full bg-cover" controls autoPlay />
          ...
          <div className=" flex gap-5 mt-4">
            ...
            <button className="bg-black/20 p-3 text-2xl rounded-full hover:bg-black/50 cursor-pointer transition-all duration-300" onClick={() => {setShowVideo(false) 
            setVideoUrl(null)}
            }>
            <IoCloseSharp />
          </button>
